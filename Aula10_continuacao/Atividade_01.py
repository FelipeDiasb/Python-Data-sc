...
#plt.plot(ano, vendas, marker='o',color = 'white', linestyle='-', color='blue') 
plt.plot(ano, vendas, marker='o', color='blue', linestyle='-', markerfacecolor='red', markeredgecolor='black', markersize=8) 
plt.xlabel('Ano')
plt.xticks(ano)
